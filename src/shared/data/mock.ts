...
export const AGENT_TASKS = [
  {
    id: "t1",
    agent: "Architect (Groq · Llama 3.3 70B)",
    agentIcon: "🎨",
    task: "Generar propuesta de requisitos y arquitectura",
    phase: "prp" as const,
  ...
  {
    id: "t2",
    agent: "DbWorker (Groq · Llama 3.1 8B)",
    agentIcon: "🗄️",
    task: "Diseñar esquemas SQL y políticas RLS",
  ...
  {
    id: "t3",
    agent: "ApiWorker (Groq · Llama 3.1 8B)",
    agentIcon: "⚙️",
    task: "Generar endpoints API + typecheck real",
    phase: "api" as const,
    status: "pending" as const,
    progress: 0,
  },
  {
    id: "t4",
    agent: "UiWorker (Groq · Llama 3.1 8B)",
    agentIcon: "💻",
    task: "Generar componentes UI + build real",
  ...
  {
    id: "t5",
    agent: "QaWorker (Groq · Llama 3.1 8B)",
    agentIcon: "🧪",
    task: "Generar y ejecutar pruebas automatizadas",
    phase: "qa" as const,
    status: "pending" as const,
    progress: 0,
  },
  {
    id: "t6",
    agent: "DeployWorker (Build + Vercel)",
    agentIcon: "🚀",
    task: "Build de producción y despliegue",
